export type I18nScope = {
  record_has_ben_saved_response: string
  ...
  warning_modal_title: string
  error_modal_title: string
  button_close_title: string
  button_submit_title: string
  error_form_empty: string
  error_register_not_found: string
